...
const businessController = __importStar(require("../controllers/meeting.controller"));
...
router.put('/meetings/:id', authentication_middlewares_1.checkAdminRole, businessController.UpdateMeeting);
